...
public class ReelCollabRequestActivity extends AppCompatActivity {
    ...
    static class ReqAdapter extends RecyclerView.Adapter<ReqAdapter.VH>{
        ...
        @NonNull @Override public VH onCreateViewHolder(@NonNull ViewGroup p,int vt){return new VH(LayoutInflater.from(p.getContext()).inflate(R.layout.item_collab_request,p,false));}
