    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        adapter = new StatusListAdapter(
            ...
            (ownerUid, ownerName) -> {
                ...
                // NEW v26: pass ordered contact list for auto-advance
                ArrayList<String> cUids  = new ArrayList<>(statusMap.keySet());
                ArrayList<String> cNames = new ArrayList<>();
                for (String uid2 : cUids) {
                    List<StatusItem> its = statusMap.get(uid2);
                    String cName = (its != null && !its.isEmpty() && its.get(0).ownerName != null)
                            ? its.get(0).ownerName : "";
                    cNames.add(cName);
                }
                i.putStringArrayListExtra(StatusViewerActivity.EXTRA_CONTACT_UIDS,  cUids);
                i.putStringArrayListExtra(StatusViewerActivity.EXTRA_CONTACT_NAMES, cNames);
                startActivity(i);
            },
