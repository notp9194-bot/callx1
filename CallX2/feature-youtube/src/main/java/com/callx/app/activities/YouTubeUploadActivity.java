...
public class YouTubeUploadActivity extends AppCompatActivity {
    ...
    private void saveToFirebase() {
        // FIXED: videoUrl null check — server se upload fail hua hoga
        if (uploadedVideoUrl == null || uploadedVideoUrl.trim().isEmpty()) {
            setLoading(false);
            Toast.makeText(this, "Video upload failed — server se URL nahi mila. Server check karo.", Toast.LENGTH_LONG).show();
            return;
        }
