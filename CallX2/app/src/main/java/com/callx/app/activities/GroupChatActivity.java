...
public class GroupChatActivity extends AppCompatActivity
    ...
    @Override public void onCopy(Message m) {
        ...
        if (cm != null) cm.setPrimaryClip(
                android.content.ClipData.newPlainText("message", m.text));
    ...
    @Override public void onInfo(Message m) {
        ...
        new androidx.appcompat.app.AlertDialog.Builder(this)
                ...
                .setMessage("Sent: " + sent + "\nStatus: " + (m.status != null ? m.status : "sent"))
    ...
    @Override public boolean onCreateOptionsMenu(Menu menu) {
        // Primary: Group Info — always visible
        menu.add(0, R.id.menu_group_info, 0, "ℹ Group Info")
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
        // Group Settings — always visible
