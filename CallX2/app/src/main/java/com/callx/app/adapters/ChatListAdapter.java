...
public class ChatListAdapter extends RecyclerView.Adapter<ChatListAdapter.VH> {
    ...
    @Override public void onBindViewHolder(@NonNull VH h, int pos) {
        ...
        // Change 4: circleCrop ensures perfectly round avatar
        ...
        if (unread > 0) {
            ...
            h.tvLastMessage.setTextColor(ContextCompat.getColor(ctx, R.color.text_primary));
        } else {
            h.tvUnread.setVisibility(View.GONE);
            h.tvLastMessage.setTextColor(ContextCompat.getColor(ctx, R.color.text_secondary));
        }
