...
public class ChatActivity extends AppCompatActivity
        ...
        FirebaseUtils.getChatMetaRef(chatId).child("pinnedMsg")
                .addValueEventListener(new ValueEventListener() {
                    @Override public void onDataChange(DataSnapshot snap) {
                        ...
                        if (has && binding.tvPinnedText != null)
                            binding.tvPinnedText.setText(pinnedMsgText != null ? pinnedMsgText : "Pinned message");
                    }
                    @Override public void onCancelled(DatabaseError e) {}
                });
    }
    ...
    private void showReplyBar(Message m) {
        ...
        if (binding.tvReplyText != null) binding.tvReplyText.setText(
