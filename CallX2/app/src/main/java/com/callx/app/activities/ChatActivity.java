...
public class ChatActivity extends AppCompatActivity
    ...
    private void pushMessage(Message msg) {
        ...
        PushNotify.notifyMessage(partnerUid, currentUid, currentName, chatId, msg.id, previewText(msg), msg.type, msg.mediaUrl);
    ...
    private void toggleRecording() {
        if (!isRecording) {
            ...
            android.net.Uri audioUri = recorder.stop(this);
            isRecording = false;
    ...
    private void uploadAndSend(Uri uri, String type) {
        ...
        String resourceType = ("image".equals(type) || "gif".equals(type)) ? "image"
