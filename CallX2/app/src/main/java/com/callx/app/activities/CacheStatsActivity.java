...
public class CacheStatsActivity extends AppCompatActivity {
    ...
    // FIX v14: Auto-refresh every 3 seconds so hit/miss counters update in real-time
    private static final long AUTO_REFRESH_MS = 3000L;
    private final Runnable mAutoRefreshRunnable = new Runnable() {
        @Override public void run() {
            loadStats();
            mainThread.postDelayed(this, AUTO_REFRESH_MS);
        }
    };
    ...
    protected void onResume() {
        super.onResume();
        loadStats();
        // FIX v14: Start auto-refresh when screen is visible
        mainThread.postDelayed(mAutoRefreshRunnable, AUTO_REFRESH_MS);
    }

    @Override
    protected void onPause() {
        super.onPause();
        // FIX v14: Stop auto-refresh when screen goes away — save battery
        mainThread.removeCallbacks(mAutoRefreshRunnable);
    }
