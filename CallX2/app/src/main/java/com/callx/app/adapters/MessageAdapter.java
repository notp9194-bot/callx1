                ...
                if (h.flVideo != null) {
                    ...
                    h.flVideo.setOnClickListener(v -> {
                        android.content.Intent intent = new android.content.Intent(
                                ctx, com.callx.app.activities.VideoPlayerActivity.class);
                        intent.putExtra(
                                com.callx.app.activities.VideoPlayerActivity.EXTRA_VIDEO_URL,
                                videoUrl);
                        intent.putExtra(
                                com.callx.app.activities.VideoPlayerActivity.EXTRA_THUMB_URL,
                                m.thumbnailUrl);
                        intent.putExtra(
                                com.callx.app.activities.VideoPlayerActivity.EXTRA_DURATION_MS,
