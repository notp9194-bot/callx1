...
public class PushNotify {
    ...
    /**
     * Convenience wrapper: notifyGroupMessage(groupId, fromUid, fromName, groupName, messageId, text, type)
     * Maps to notifyGroupRich with empty fromPhoto and mediaUrl.
     */
