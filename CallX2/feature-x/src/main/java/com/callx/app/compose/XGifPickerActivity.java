...
/**
 * XGifPickerActivity — GIF search via Tenor API.
 *
 * Integration steps (one-time):
 *   1. Get a free Tenor API key: https://tenor.com/developer/dashboard
 *   2. Add to strings.xml:  <string name="tenor_api_key">YOUR_KEY</string>
 *   3. Activity is then fully functional.
 *
 * Returns: Intent with "gif_url" and "gif_preview_url" extras.
 */
public class XGifPickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_x_gif_picker);
    ...
    private String getTenorKey() {
        ...
        return "LIVDSRZULELA"; // Tenor demo key (low rate limit)
    }
