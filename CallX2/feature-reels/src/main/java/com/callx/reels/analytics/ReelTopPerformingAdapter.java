...
public class ReelTopPerformingAdapter extends RecyclerView.Adapter<ReelTopPerformingAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_top_performing_reel, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvViews.setText(String.format(Locale.US, "%,d", m.views));
        holder.tvEngage.setText(String.format(Locale.US, "%.1f%%", m.engagementRate));
