package com.callx.app.adapters;
  ...
  public class HomeChallengeAdapter extends RecyclerView.Adapter<HomeChallengeAdapter.ChallengeVH> {
      ...
      @NonNull @Override public ChallengeVH onCreateViewHolder(@NonNull ViewGroup p,int vt){return new ChallengeVH(LayoutInflater.from(ctx).inflate(R.layout.item_home_challenge,p,false));}
