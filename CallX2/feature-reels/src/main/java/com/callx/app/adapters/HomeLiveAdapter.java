package com.callx.app.adapters;
  ...
  public class HomeLiveAdapter extends RecyclerView.Adapter<HomeLiveAdapter.LiveVH> {
      ...
      @NonNull @Override public LiveVH onCreateViewHolder(@NonNull ViewGroup p, int vt){
          return new LiveVH(LayoutInflater.from(ctx).inflate(R.layout.item_home_live_user,p,false));}
