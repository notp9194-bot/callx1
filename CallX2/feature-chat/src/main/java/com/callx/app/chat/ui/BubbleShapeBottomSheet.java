...
public class BubbleShapeBottomSheet extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View shapePreview = new View(ctx);
        LinearLayout.LayoutParams spLp = new LinearLayout.LayoutParams(dp(36), dp(22));
        spLp.setMarginEnd(dp(14));
        spLp.gravity = Gravity.CENTER_VERTICAL;
        shapePreview.setLayoutParams(spLp);
        GradientDrawable spBg = new GradientDrawable();
        spBg.setColor(0xFF1E293B);
        spBg.setCornerRadius(dp(11));
        shapePreview.setBackground(spBg);
        card.addView(shapePreview);
        ...
        desc.setText("Smooth rounded corners — active");
