...
public abstract class AppDatabase extends RoomDatabase {
    ...
    /** v9 → v10: gifId + gifUrl + gifPreviewUrl — GIPHY GIF support. */
    static final Migration MIGRATION_9_10 = new Migration(9, 10) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase db) {
            db.execSQL("ALTER TABLE messages ADD COLUMN gifId TEXT DEFAULT NULL");
            db.execSQL("ALTER TABLE messages ADD COLUMN gifUrl TEXT DEFAULT NULL");
            db.execSQL("ALTER TABLE messages ADD COLUMN gifPreviewUrl TEXT DEFAULT NULL");
        }
    };
