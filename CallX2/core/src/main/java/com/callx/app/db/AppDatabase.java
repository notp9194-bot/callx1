...
/**
 * v34: AppDatabase — Room database (WhatsApp-level offline-first architecture).
 *
 * Schema bump: 33 → 34
 * Migration adds:
 *   NEW tables: channels, channel_posts
 *   (Channels feature: offline-first via ChannelRepository + ChannelDao)
 */
@Database(
    entities = {
        // User
