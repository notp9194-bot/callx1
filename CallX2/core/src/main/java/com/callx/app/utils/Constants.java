...
public class Constants {
    ...
    public static final String EXTRA_GROUP_CALLER_PHOTO = "extra_gcall_caller_photo";
    ...
    // ── NEW: Incoming call reject with note ───────────────────────────────
    // Receiver incoming call decline karte waqt voice note ya video note record kar sakta hai
    // Yeh note caller ko chat mein jayega (jaise caller ke side mein AddNoteActivity bhejta hai)
    public static final String ACTION_REJECT_WITH_VOICE_NOTE = "com.callx.app.REJECT_WITH_VOICE_NOTE";
    public static final String ACTION_REJECT_WITH_VIDEO_NOTE = "com.callx.app.REJECT_WITH_VIDEO_NOTE";
